...
Genesis 11 closes the primeval history. The tower of Babel — humanity unified in ambition to "make us a name" — meets the divine confusion of language and the scattering that <VerseRef book="genesis" chapter={10} /> has already mapped. Then the chapter pivots: a focused genealogy of Shem leading to Terah, then to Abram and Sarai, and the migration from Ur of the Chaldees to Haran. The chapter is the funnel from universal humanity to the one family through whom blessing will reach every nation — and the threshold of the patriarchal narrative that the rest of Genesis will tell.
