...
highlightSummary: >
  ...
  face to face, is shown the whole creation, and learns that he is a son of
  God. When the divine presence withdraws, Satan appears and demands worship;
  Moses, measuring the two glories against each other, refuses and commands
  him away. A renewed vision follows, in which God reveals his purpose — "to
  bring to pass the immortality and eternal life of man" — and commissions
  Moses to write.
externalLinks:
...
That commission is the hinge. Moses 1 exists to frame what follows. Having seen the Creator, learned his own standing as a son of God, withstood the counterfeit, and received his charge to write, Moses is now prepared — and the very next chapter, <VerseRef book="moses" chapter={2} />, begins the creation account that runs closely parallel to <VerseRef book="genesis" chapter={1} />. The vision is the doorway; the Genesis material is the room it opens onto.

<LangNotes>

**Relationship to Genesis and Theological Notes**

*A note on sources.* The Book of Moses originated in Joseph Smith's revision of the Bible — the work usually called the Joseph Smith Translation — begun in June 1830. It was not rendered from a Hebrew manuscript, so there is no underlying original-language text to annotate; the notes here concern the chapter's structure and its relationship to Genesis.
