...
*A note on method.* There is no original-language text behind the Book of Mormon to consult, so the notes here trace intertextual links — the chapter's many points of contact with the New Testament — rather than vocabulary.
